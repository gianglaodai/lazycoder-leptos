...
(
    ...
    uid         UUID         NOT NULL
        CONSTRAINT UN_attributes_uid UNIQUE,
...
(
    id             SERIAL
        CONSTRAINT PK_attributes_values PRIMARY KEY,
    uid            UUID         NOT NULL
        CONSTRAINT UN_attribute_values_uid UNIQUE,
    version        INTEGER      NOT NULL DEFAULT 0,
    created_at     TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    updated_at     TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    int_value      INTEGER,
...
(
    ...
    uid        UUID         NOT NULL
        CONSTRAINT UN_users_uid UNIQUE,
    version    INTEGER      NOT NULL DEFAULT 0,
    created_at TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
    username   CITEXT       NOT NULL
        CONSTRAINT UN_users_username UNIQUE,
...
(
    id         SERIAL
        CONSTRAINT PK_post_types PRIMARY KEY,
    uid        UUID        NOT NULL
        CONSTRAINT UN_post_types_uid UNIQUE,
    version    INTEGER     NOT NULL DEFAULT 0,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    code       TEXT        NOT NULL
        CONSTRAINT UN_post_types_code UNIQUE,
    name       TEXT        NOT NULL,
...
(
    ...
    uid          UUID        NOT NULL
        CONSTRAINT UN_posts_uid UNIQUE,
    version      INTEGER     NOT NULL DEFAULT 0,
    created_at   TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at   TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    slug         TEXT        NOT NULL,
...
(
    id          SERIAL
        CONSTRAINT PK_posts_collections PRIMARY KEY,
    uid         UUID        NOT NULL
        CONSTRAINT UN_posts_collections_uid UNIQUE,
    version     INTEGER     NOT NULL DEFAULT 0,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    slug        TEXT        NOT NULL
        CONSTRAINT UN_posts_collections_slug UNIQUE,
    title       TEXT        NOT NULL,
    description TEXT,
    visibility  TEXT        NOT NULL DEFAULT 'public',
...
(
    id         SERIAL
        CONSTRAINT PK_post_taxonomies PRIMARY KEY,
    uid        UUID        NOT NULL
        CONSTRAINT UN_post_taxonomies_uid UNIQUE,
    version    INTEGER     NOT NULL DEFAULT 0,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    code       TEXT        NOT NULL
        CONSTRAINT UN_post_taxonomies_code UNIQUE, /*'category', 'tag', 'topic', 'tech', 'tool'...*/
    name       TEXT        NOT NULL,
...
(
    ...
    uid         UUID        NOT NULL
        CONSTRAINT UN_terms_uid UNIQUE,
    version     INTEGER     NOT NULL DEFAULT 0,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
