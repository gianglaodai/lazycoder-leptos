#![cfg(feature = "ssr")]
use crate::business::post_term_service::{
    PostTerm, PostTermInfo, PostTermInfoRepository, PostTermRepository,
};
...
define_orm_with_common_fields!(PostTerm {
    pub post_id: i32,
    pub term_id: i32,
});
...
impl From<PostTermOrm> for PostTerm {
    fn from(orm: PostTermOrm) -> Self {
        Self {
            id: orm.id,
...
#[derive(Clone)]
pub struct PostTermSqlxRepository {
    pool: PgPool,
}
#[derive(Clone)]
...
impl PostTermSqlxRepository {
    pub fn new(pool: PgPool) -> Self {
        Self { pool }
    }
}

impl SqlxViewMeta for PostTermSqlxRepository {
    ...
    fn get_searchable_columns(&self) -> Vec<&str> {
        PostTermOrm::searchable_columns()
    }
}

impl SqlxViewRepository for PostTermSqlxRepository {
    type Entity = PostTerm;
    type Orm = PostTermOrm;
...
impl PostTermRepository for PostTermSqlxRepository {}
