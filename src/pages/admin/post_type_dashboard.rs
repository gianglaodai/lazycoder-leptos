...
use crate::pages::rest::post_type_api::{load_post_type_infos, create_post_type, PostTypeInfoTO};
use leptos::prelude::*;
use leptos::{component, view, IntoView};

#[component]
pub fn AdminPostTypesDashboardPage() -> impl IntoView {
                    ...
                    <main class="flex-1 min-h-screen">
                        <div class="container-page py-10 font-serif">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <Dialog>
                                    <DialogTrigger>
                                        <Button intent=crate::pages::components::button::ButtonIntent::Primary>"New Post Type"</Button>
                                    </DialogTrigger>
                                    <DialogContent>
                                        <DialogHeader>
                                        ...
                                        <Form on_submit=Callback::new({
                                            ...
                                            <FormField name="code">
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="PT_CODE" value=code on_input=Callback::new(move |ev: leptos::ev::Event| code.set(event_target_value(&ev))) />
                                                    </FormControl>
                                                </FormItem>
                                            </FormField>
                                            <FormField name="name">
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Post Type Name" value=name on_input=Callback::new(move |ev: leptos::ev::Event| name.set(event_target_value(&ev))) />
                                                    </FormControl>
                                                </FormItem>
                                            </FormField>
                                            <DialogFooter>
                                    ...
                                    Some(Ok(items)) => view!{
                                        <div class="overflow-x-auto bg-white border border-stone-200 rounded-lg">
                                            <table class="min-w-full text-sm">
                                                ...
                                                <tbody>
                                                    {items.into_iter().map(|it: PostTypeInfoTO| view!{
                                                        <tr class="border-t">
