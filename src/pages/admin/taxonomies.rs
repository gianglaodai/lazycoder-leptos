...
fn DataTableCtx() -> impl IntoView {
    ...
    let ts: Arc<TableState<crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO>> = expect_context();
...
pub fn AdminTaxonomiesPage() -> impl IntoView {
    ...
    let table_state: Arc<TableState<crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO>> = Arc::new(TableState::new());
    ...
    table_state.columns.set(vec![
        ColumnDef { id: "id", header_name: "ID", value_getter: Some(Arc::new(|p: &crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO| Value::Number(p.id as f64))), value_formatter: None, cell_renderer: None, cell_editor: None, sortable: true, filterable: true, resizable: true, movable: false, pinned: Pinned::None, width: 80, min_width: 60, max_width: Some(140), groupable: false, aggregate: None, comparator: None, field: Some("id"), data_type: Some(crate::pages::components::datatable::core::column::DataType::Int), },
        ColumnDef { id: "code", header_name: "Code", value_getter: Some(Arc::new(|p: &crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO| Value::Text(p.code.clone()))), value_formatter: None, cell_renderer: None, cell_editor: None, sortable: true, filterable: true, resizable: true, movable: true, pinned: Pinned::None, width: 220, min_width: 120, max_width: None, groupable: false, aggregate: None, comparator: None, field: Some("code"), data_type: Some(crate::pages::components::datatable::core::column::DataType::Text), },
        ColumnDef { id: "name", header_name: "Name", value_getter: Some(Arc::new(|p: &crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO| Value::Text(p.name.clone()))), value_formatter: None, cell_renderer: None, cell_editor: None, sortable: true, filterable: true, resizable: true, movable: true, pinned: Pinned::None, width: 260, min_width: 120, max_width: None, groupable: false, aggregate: None, comparator: None, field: Some("name"), data_type: Some(crate::pages::components::datatable::core::column::DataType::Text), },
        ColumnDef { id: "updated_at", header_name: "Updated", value_getter: Some(Arc::new(|p: &crate::pages::rest::post_taxonomy_info_api::PostTaxonomyInfoTO| Value::Text(p.updated_at.to_string()))), value_formatter: None, cell_renderer: None, cell_editor: None, sortable: true, filterable: false, resizable: true, movable: true, pinned: Pinned::None, width: 180, min_width: 140, max_width: None, groupable: false, aggregate: None, comparator: None, field: Some("updated_at"), data_type: Some(crate::pages::components::datatable::core::column::DataType::DateTime), },
    ]);
    ...
    let resource = Resource::new(
        ...
        |(first_result_i32, max_results_i32, sort, search)| async move {
            use crate::pages::rest::post_taxonomy_info_api::{load_post_taxonomy_infos, count_post_taxonomy_infos};
            let (a, b) = futures::join!(
                load_post_taxonomy_infos(first_result_i32 as i64, max_results_i32, sort.clone(), search.clone(), None, None),
