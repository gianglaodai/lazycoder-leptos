...
pub fn AdminTermsPage() -> impl IntoView {
    ...
    table_state.columns.set(vec![
        ColumnDef {
            id: "id",
            header_name: "ID",
            value_getter: Some(Arc::new(|p: &TermInfoTO| Value::Number(p.id as f64))),
        ...
        ColumnDef {
            ...
            value_getter: Some(Arc::new(|p: &TermInfoTO| {
                Value::Text(p.taxonomy_code.clone())
            })),
            value_formatter: None,
            cell_renderer: None,
            cell_editor: None,
        ...
        ColumnDef {
            ...
            header_name: "Parent",
            value_getter: Some(Arc::new(|p: &TermInfoTO| {
                Value::Text(p.parent_slug.clone().unwrap_or_default())
            })),
            value_formatter: None,
            cell_renderer: None,
            cell_editor: None,
            ...
            aggregate: None,
            comparator: None,
            field: Some("parent_slug"),
            data_type: Some(crate::pages::components::datatable::core::column::DataType::Text),
        },
        ColumnDef {
            id: "slug",
            header_name: "Slug",
            value_getter: Some(Arc::new(|p: &TermInfoTO| Value::Text(p.slug.clone()))),
            value_formatter: None,
            cell_renderer: None,
            cell_editor: None,
            sortable: true,
        ...
        ColumnDef {
            id: "name",
            header_name: "Name",
            value_getter: Some(Arc::new(|p: &TermInfoTO| Value::Text(p.name.clone()))),
            value_formatter: None,
            cell_renderer: None,
            cell_editor: None,
            sortable: true,
