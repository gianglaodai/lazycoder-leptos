...
pub fn AdminPostCollectionsPage() -> impl IntoView {
    ...
    let resource = Resource::new(
        ...
        |(first_result_i32, max_results_i32, sort, search)| async move {
            use crate::pages::rest::post_collection_info_api::{load_post_collection_infos, count_post_collection_infos};
            let (a, b) = futures::join!(
                load_post_collection_infos(first_result_i32 as i64, max_results_i32, sort.clone(), search.clone(), None, None),
