...
impl From<PostRelationInfo> for PostRelationInfoTO {
    fn from(entity: PostRelationInfo) -> Self {
        Self {
            id: entity.id,
            uid: entity.uid,
            ...
            from_post: entity.from_post,
            to_post: entity.to_post,
            rel_type: entity.rel_type,
            from_slug: entity.from_slug,
            from_title: entity.from_title,
            to_slug: entity.to_slug,
            to_title: entity.to_title,
        }
    }
}
